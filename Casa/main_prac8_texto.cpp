...
CTexture t_Madera;//Textura de Madera
CTexture t_MO;//Textura de transparencia
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_Madera.LoadTGA("MADERA.tga");//Textura de Madera sin esta no se puede visualizar la imagen
	t_Madera.BuildGLTexture();
	t_Madera.ReleaseImage();

	t_MO.LoadTGA("esfera1.tga");//Textura de Transparencia sin esta no se puede visualizar la imagen
	t_MO.BuildGLTexture();
	t_MO.ReleaseImage();
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	//Borde1:Metal
		...
		glPushMatrix();
		   ...
		   prisma(t_Ajedrez1.GLindex, t_Madera.GLindex);
		glPopMatrix();
		//Borde4:Madera
		glPushMatrix();
		   glColor3f(1.0, 1.0, 1.0);
		...
		glPushMatrix();
		   ...
		   prisma(t_metal01.GLindex, t_metal01.GLindex);
		glPopMatrix();
		//Silla con transparencias
		//Respaldo
		glPushMatrix();
		glColor3f(1.0, 1.0, 1.0);
		glTranslatef(-3.37, 0.5, 1.5);
		glScalef(0.25, 4.0, 2.0);
		prisma(t_MO.GLindex, t_MO.GLindex);
		glPopMatrix();
		//Asiento
		glPushMatrix();
		   glColor3f(1.0, 1.0, 1.0);
		   glTranslatef(-3.0, -2.0, 1.5);
